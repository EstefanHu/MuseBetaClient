...
export const Terms = () => (
  <section style={styles.container}>
    <section style={styles.terms}>
      ...
      <h2 style={styles.date}>Last updated June 15, 2020</h2>

      <section style={styles.section}>
        <h3 style={styles.title}>AGREEMENT TO TERMS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
            These Terms of Use constitute a legally binding agreement made between you,
              whether personally or on behalf of an entity (“you”) and Project:Muse, doing business as :Muse ("<strong>:Muse</strong>", “<strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”), concerning your access to and use of the <a href='http://www.projectmuse.co'>http://www.projectmuse.co</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>INTELLECTUAL PROPERTY RIGHTS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
          ...
          <p style={styles.paragraph}>
            rovided that you are eligible to use the Site, you are granted a limited license to access and use the Site and to download or print a copy of any portion of the Content to which you have properly gained access solely for your personal, non-commercial use. We reserve all rights not expressly granted to you in and to the Site, the Content and the Marks.
            </p>
        </article>
      </section>

      <section style={styles.section}>
        <h3 style={styles.title}>USER REPRESENTATIONS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>PROHIBITED ACTIVITIES</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>USER GENERATED CONTRIBUTIONS </h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>CONTRIBUTION LICENSE</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>GUIDELINES FOR REVIEWS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>MOBILE APPLICATION LICENSE</h3>
        <article style={styles.article}>
          <h4 style={styles.articleTitle}>Use License</h4>
          <p style={styles.paragraph}>
        ...
        <article style={styles.article}>
          <h4 style={styles.articleTitle}>Apple and Android Devices</h4>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>SUBMISSIONS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>THIRD-PARTY WEBSITE AND CONTENT</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>SITE MANAGEMENT</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        ...
        <article style={styles.article}>
          <p style={styles.paragraph}>
            We care about data privacy and security. Please review our Privacy Policy: <a href='/privacy'>here</a>. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.
            </p>
        </article>
      </section>

      <section style={styles.section}>
        <h3 style={styles.title}>COPYRIGHT INFRINGEMENTS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>TERM AND TERMINATION</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>MODIFICATIONS AND INTERRUPTIONS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>DISPUTE RESOLUTION</h3>
        <article style={styles.article}>
          <h4 style={styles.articleTitle}>Binding Arbitration</h4>
          <p style={styles.paragraph}>
        ...
        <article style={styles.article}>
          <h4 style={styles.articleTitle}>Restrictions</h4>
          <p style={styles.paragraph}>
            The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
            </p>
        </article>
        <article style={styles.article}>
          <h4 style={styles.articleTitle}>Exceptions to Arbitration</h4>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>CORRECTIONS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>LIMITATIONS OF LIABILITY</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>INDEMNIFICATION</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>USER DATA</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>CALIFORNIA USERS AND RESIDENTS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
      ...
      <section style={styles.section}>
        <h3 style={styles.title}>MISCELLANEOUS</h3>
        <article style={styles.article}>
          <p style={styles.paragraph}>
